...
public class SetupAndTeardownScenarioTrustExtCaIpsec extends SetupAndTeardownScenario {

    public static Predicate<DataRecord> extCaNodeList() {
        return PredicateUtil.genericPredicate("nodeType", Arrays.asList("RadioNode"));
    }

    public static final String EXTERNALCA_TRUST_USECASE = "Single Node Trust distribution for ExternalCA";
    ...
    public Predicate<DataRecord> correctNodeType() {
        getLogger().debug("\n SetupAndTeardownScenarioTrustExtCaIpsec correctNodeType \n");
    ...
    public List<String> rbacCustomRolesList() {
        getLogger().debug("\n SetupAndTeardownScenarioTrustExtCaIpsec rbacCustomRoles \n");
    ...
    protected void setupSpecificDataSource() {
         ...
         final TestDataSource<DataRecord> trustUsecase = fromCsv(path + "ExternalCaTrust.csv");
         context.addDataSource(EXTERNALCA_TRUST_USECASE, trustUsecase);

         ScenarioUtility.dumpDataSource();
         ScenarioUtility.debugScope(getLogger(), EXTERNALCA_TRUST_USECASE);
