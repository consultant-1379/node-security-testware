...
/**
 * SetupAndTeardownScenarioWeakCiphers Disable contains necessary operations that must be
 *  executed before and after Disabling Ciphers.
 */
@SuppressWarnings({"PMD.LawOfDemeter", "PMD.ExcessiveImports"})
public class SetupAndTeardownWeakCiphersDisable extends SetupAndTeardownScenario {
    public static final String nodeTypes = DataHandler.getConfiguration().getProperty("sso.nodeTypes", "MINI-LINK-6352",
            String.class);
    ...
    public Predicate<DataRecord> correctNodeType() {
        getLogger().info("Before checking Node Types");
        getLogger().info("\n Resulting Node Type Is:{}",nodeTypes);
        getLogger().debug("\n SetupAndTeardownWeakCiphersDisable correctNodeType \n");
    ...
    public List<String> rbacCustomRolesList() {
        getLogger().debug("\n SetupAndTeardownWeakCiphersDisable rbacCustomRoles \n");
